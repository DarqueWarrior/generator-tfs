...
describe(`build:index`, function () {
   it(`test prompts asp:paas should not return error`, function (done) {
   ...
   it(`test prompts java:paas should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
   ...
   it(`test prompts node:paas should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
   ...
   it(`test prompts node:docker should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
   ...
   it(`test prompts asp:docker should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
   ...
   it(`test prompts java:docker should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
   ...
   it(`test cmd line node:docker should not return error`, function (done) {
      helpers.run(path.join(__dirname, `../generators/build/index`))
   ...
   it(`test cmd line java:docker should not return error`, function (done) {
      helpers.run(path.join(__dirname, `../generators/build/index`))
   ...
   it(`test cmd line asp:docker should not return error`, function (done) {
      sinon.stub(util, `getPools`);
      sinon.stub(util, `findQueue`).callsArgWith(4, null, 1);
      sinon.stub(util, `findDockerServiceEndpoint`).callsArgWith(5, null, null);
      sinon.stub(util, `tryFindBuild`).callsArgWith(4, null, { value: "I`m a build." });
